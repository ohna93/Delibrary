         ...
         <article class="main_article">
			...
			<div style="border: 1px solid #eee; padding: 10px; margin: 10px 10px 10px 0px;">
               ...
               <div>
                  <div id="re_Submit">
                     <span>댓글 </span>
                     <button id="btnInsertReply" p_id="${a.p_id}" p_no="${a.p_no}" cust_no="${cust_no }" group="${group}">
                     	등록
                     	</button>
                     <textarea id="re_content" name="re_content" value="${re_content }"></textarea>
                  </div>
                  <div id="re_content">
                     <c:forEach var="r" items="${listReply }">
                        <div>
													<button id="btnDeleteReply" style="float:left" p_id="${a.p_id}" cust_no="${cust_no }" group="${group}">삭제</button>
													<button id="btnUpdateReply" style="float:left" p_id="${a.p_id}" cust_no="${cust_no }" group="${group}">수정</button>
