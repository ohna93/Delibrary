         ...
         <div class="collapse navbar-collapse noto-serif" id="navbarCollapse">
            ...
            <ul id="app" class="navbar-nav ml-auto">
               ...
               <li class="nav-item" v-bind:title="bookcart"><a
                  href="BookCart.do" class="nav-link"><i class="fas fa-book"></i></a>
      ...
      <div class="row">
         <div class="col-md-6">
            ...
            <div class="carousel slide carousel-multi-item" data-ride="carousel"
               ...
               <div class="hr-green mb-4">
                  <h3 class="d-inline-block mb-3 noto-serif">사서 추천 도서</h3>
                  <!--Controls-->
         ...
         <div class="col-md-6">
            ...
            <div class="carousel slide carousel-multi-item" data-ride="carousel"
               ...
               <div class="hr-green mb-4">
                  <h3 class="d-inline-block mb-3 noto-serif">신착 도서</h3>
                  <!--Controls-->
                  <div class="controls-bottom pull-right">
                     <a class="btn btn-outline-success prev" data-slide="prev"
         ...
         <div class="col-md-4 mb-3 noto-serif">
            <a href="addrViewpageAPI.do"><div class="home-tag mb-2">
                  <img class="pr-4 m-0" alt="찾아오시는 길" src="../img/home/map.png"
                     height="30px">찾아오시는 길
               </div></a> <a href="#"><div class="home-tag mb-2">
                  <img class="pr-4 m-0" alt="찾아오시는 길"
                     src="../img/home/telephone.png" height="30px">전화번호
               </div></a> <a href="QnaList.do"><div class="home-tag mb-2">
